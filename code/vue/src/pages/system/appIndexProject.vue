...
<template>
  <div id="projectApprovalList" style="padding: 20px">
    <!-- 立项项目列表 -->
    <div class="main">
      <div class="header">
        <div class="headerContent">
          ...
          >
            <div class="hlBottom">
              <el-form-item label="项目名称:" style="width: 260px">
                <el-select
              ...
              <el-form-item label="项目类型:" style="width: 260px">
                <el-select
              ...
              <el-form-item label="项目状态:" style="width: 260px">
                <el-select
              ...
              <!-- <el-form-item label="审批状态:" style="width: 260px">
                <el-select
          ...
          <div class="item" @click="lookinfo(1)">
            <div class="box" :style="`background: #FFDCD7;`">
              <div class="left">
                <div>
                  项目总数(个数)：
                  <CountUp :value="tjData.zong_count" />
                </div>
        ...
        >
          ...
          >
            ...
            <template slot-scope="scope">
              <span
                @click.stop="goPanel(scope.row, scope.column)"
