        ...
        <div class="appContentLeft">
          ...
          <div v-if="!searchingUser">
            ...
            <div class="item" v-for="(item, index) in roleList" :key="index">
              <div class="line">
            <el-tooltip class="item" effect="dark" :content="item.name +'（'+item.num+'）'" placement="right-start">
                <div
                  class="nameLeft"
          ...
          >
            <div v-if="viewPage">
                      ...
                      >
                        项目权限
                            <el-tooltip class="item" effect="dark"
                             ...
                             "
                              placement="top-start">
                    <div slot="content">参与的项目是指和自己相关的审批单。<br/>  所有的项目是指所有人提交的审批单,在这个前提下,角色成员添加管理范围会生效,生效后可查看,管理本人和管理范围内成员的审批单。</div>
                         <a-icon
              ...
              />
                    ...
                    <div
                      v-for="(litem, liindex) in item.child"
                      :key="liindex"
                      :class="
                    ...
                    >
                      ...
                      <div class="acrbFooter acf1">
                        <el-checkbox
                          v-for="(ilist, lindex) in litem.child"
                          :label="ilist.id"
                          :disabled="isDisa"
...
export default {
  ...
  methods: {
    ...
    getAllPower() {
      this.$axios
        .post('/finance/powerlist', { id: this.roleId })
        .then(res => {
          if (res.data.code == 1) {
            this.PowerList = res.data.content;
