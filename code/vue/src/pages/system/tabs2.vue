<template>
  <div id="qualityAnalysis">
    <div class="main">
      <div class="top">
        <componenTtiles :indexs="2" :pid="pid" :pname="pname"></componenTtiles>
      </div>
    </div>
    ...
    <div class="centerXm">
        ...
        <div v-for="(item, index) in oneList" class="oneLeftItem" :key="index">
          <div style="margin-left: 25px">
            <div style="width: 43px; height: 43px">
              <img
                :src="require(`../../assets/twoImg/item2${index + 1}.png`)"
                mode=""
      ...
      <div class="centerTwo">
        <div style="position: relative">
          <div class="line"></div>
          <div style="margin-left: 8px; font-weight: bold">安全问题分析</div>
        </div>
        <div class="centerTwoChan">
          ...
          <div style="display: flex; align-items: center">
            <div style="display: flex; align-items: center">
              <div class="orange" style="background: #fcb223"></div>
              <div class="right" style="margin-right: 10px">安全整改通知单</div>
            </div>
            <div style="display: flex; align-items: center">
              <div class="orange" style="background: #3297fb"></div>
        ...
        <div class="three" style="padding: 0; position: relative">
          ...
          <div v-if="tableData.length == 0" class="posImg">
            <img
              ...
              <el-col :span="21">
                ...
                >
                  ...
                  >
                    ...
                    <div class="child">
                      {{ item.rectify_notice_count || 0 }}
                    </div>
                    <div class="child">{{ item.rectify_reply_count || 0 }}</div>
                    <div class="child">
                      {{
                        (
                          item.rectify_reply_count / item.rectify_notice_count
                        ).toFixed(2) || 0
                      }}%
                    </div>
                  </div>
      ...
      <div class="centerTwo">
        <div style="position: relative">
          <div class="line"></div>
          <div style="margin-left: 8px; font-weight: bold">安全事故分析</div>
        </div>
        <div class="centerTwoChan">
          <div>
            <span
        ...
        <div class="three" style="padding: 0; position: relative">
          ...
          ></div>
          <div v-if="tableData1.length == 0" class="posImg1">
            <img
              src="@/assets/twoImg/bianji1.png"
              alt=""
              style="width: 156px; height: 125px; margin-top: 45px"
      ...
      <div class="centerTwo">
        ...
        >
          ...
          <el-table-column prop="unit" label="公司名称"> </el-table-column>

          <el-table-column prop="is_coop" label="有无其他合作项目">
            <template slot-scope="scope">
              <div
                v-if="scope.row.is_coop == '有'"
                style="color: #3296fa"
                @click="showCt(scope.row)"
              >
                有
              </div>
              <div v-else>无</div>
          ...
          <el-table-column prop="rectify_count" label="整改数量">
          </el-table-column>
          <template slot="empty">
            <slot name="empty">
              <img
...
export default {
  ...
  data() {
    return {
      ...
      tableData: [
        // {
        //   type: '木工', //类型
        //   rectify_notice_count: '1', //安全整改通知条数
        //   rectify_reply_count: '2', //安全整改回复条数
        // },
        // {
        //   type: '木工1', //类型
        //   rectify_notice_count: '2', //安全整改通知条数
        //   rectify_reply_count: '3', //安全整改回复条数
        // },
        // {
        //   type: '木工2', //类型
        //   rectify_notice_count: '3', //安全整改通知条数
        //   rectify_reply_count: '4', //安全整改回复条数
        // },
        // {
        //   type: '木工3', //类型
        //   rectify_notice_count: '4', //安全整改通知条数
        //   rectify_reply_count: '5', //安全整改回复条数
        // },
        // {
        //   type: '木工', //类型
        //   rectify_notice_count: '5', //安全整改通知条数
        //   rectify_reply_count: '6', //安全整改回复条数
        // },
        // {
        //   type: '木工1', //类型
        //   rectify_notice_count: '6', //安全整改通知条数
        //   rectify_reply_count: '7', //安全整改回复条数
        // },
        // {
        //   type: '木工2', //类型
        //   rectify_notice_count: '7', //安全整改通知条数
        //   rectify_reply_count: '8', //安全整改回复条数
        // },
        // {
        //   type: '木工3', //类型
        //   rectify_notice_count: '9', //安全整改通知条数
        //   rectify_reply_count: '10', //安全整改回复条数
        // },
        // {
        //   type: '木工', //类型
        //   rectify_notice_count: '10', //安全整改通知条数
        //   rectify_reply_count: '11', //安全整改回复条数
        // },
        // {
        //   type: '木工1', //类型
        //   rectify_notice_count: '11', //安全整改通知条数
        //   rectify_reply_count: '12', //安全整改回复条数
        // },
        // {
        //   type: '木工2', //类型
        //   rectify_notice_count: '12', //安全整改通知条数
        //   rectify_reply_count: '13', //安全整改回复条数
        // },
        // {
        //   type: '木工3', //类型
        //   rectify_notice_count: '12', //安全整改通知条数
        //   rectify_reply_count: '14', //安全整改回复条数
        // },
      ],
      tableData1: [
        // {
        //   type: '木工', //类型
        //   accident_count: '1', //安全整改通知条数
        //   accident_money: '2', //安全整改回复条数
        // },
        // {
        //   type: '木工1', //类型
        //   accident_count: '2', //安全整改通知条数
        //   accident_money: '3', //安全整改回复条数
        // },
        // {
        //   type: '木工2', //类型
        //   accident_count: '3', //安全整改通知条数
        //   accident_money: '4', //安全整改回复条数
        // },
        // {
        //   type: '木工3', //类型
        //   accident_count: '4', //安全整改通知条数
        //   accident_money: '5', //安全整改回复条数
        // },
        // {
        //   type: '木工', //类型
        //   accident_count: '5', //安全整改通知条数
        //   accident_money: '6', //安全整改回复条数
        // },
        // {
        //   type: '木工1', //类型
        //   accident_count: '6', //安全整改通知条数
        //   accident_money: '7', //安全整改回复条数
        // },
        // {
        //   type: '木工2', //类型
        //   accident_count: '7', //安全整改通知条数
        //   accident_money: '8', //安全整改回复条数
        // }
      ],
      tableDatas: [],
      oneList: [
      ...
      changList: [{ title: '安全整改图表分析' }, { title: '按负责人排名' }],
  ...
  methods: {
    ...
    //获取穿透dialog里所有数据
    getpierceList(row, column) {
      console.log(row.unit, 'getpierceListgetpierceList');
      this.$axios
        ...
        .then(res => {
          ...
          console.log(
            this.tableList,
            'this.tableListthis.tableListthis.tableList',
          );
        });
    ...
    getDkb(e) {
      this.$axios
        .post('/bulletin/securityUnitProblem', {
          project_id: this.pid,
          project_name: this.pname,
    ...
    getDTList(row) {
      this.$axios
        .post('/bulletin/securityAccidentProblem', {
          project_id: this.pid,
          project_name: this.pname,
          type: row,
        })
