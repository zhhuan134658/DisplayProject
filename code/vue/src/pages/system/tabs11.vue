<template>
  <div id="qualityAnalysis">
    <div class="main">
      <div class="top">
        <componenTtiles :indexs="11" :pid="pid" :pname="pname"></componenTtiles>
      </div>
    </div>
      ...
      <div class="centerTwo">
        ...
        <div class="three" style="padding: 0; position: relative">
          ...
          >
            ...
            <el-table-column prop="name" label="机械租赁名称">
            </el-table-column>
...
export default {
  ...
  methods: {
    getList(ntype) {
      this.$axios
        .post('/bulletin/leaseContractAnalysisUnit', {
    ...
    getList1(ntype) {
      this.$axios
        .post('/bulletin/leaseMainAnalysis', {
          project_name: this.pname,
          project_id: this.pid,
        })
        .then(res => {
    ...
    drawLine1() {
      ...
      console.log(nameLit,"nameLit11")
      console.log(countLit,"countLit11")
      console.log(this.Datas1,"this.Datas111")
