/* * @Author: NorthWind * @Date: 2020-12-12 13:59:24 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 14:02:15 */
<template>
  <div id="moneyManageList">
    <!-- 资金支出列表 -->
    <div class="main">
      <!-- 搜索条件 -->
      <commonSearch
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="expenditure_fund_plan"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/expenditureFundPlan')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    backList() {
      this.$axios
        .post('/project/expenditureFundPlanReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/expenditureFundPlanDownload', {
