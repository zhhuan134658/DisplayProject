/* * @Author: NorthWind * @Date: 2020-12-09 18:01:39 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 13:59:09 */
<template>
  <div id="safeCheck">
    <!-- 安全检查列表 -->
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="safety_inspection_record"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/safetyInspectionRecord')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/safetyInspectionRecordDownload', {
