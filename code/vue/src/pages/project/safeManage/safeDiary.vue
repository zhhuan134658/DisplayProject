/*
 * @Author: NorthWind 
 * @Date: 2020-12-09 17:30:09 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-08-16 16:28:27
 */
<template>
  <div id="safeDiary">
    <!-- 安全日志列表 -->
...
export default {
  ...
  methods: {
    ...
    backList() {
      this.$axios
        .post('/project/securityLogReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/securityLogDownload', {
