/* * @Author: NorthWind * @Date: 2021-04-14 11:34:47 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 14:34:34 */
<template>
    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="sub_visa_change"
        ></commonTable>
        <div class="page">
          <el-pagination
