/* * @Author: NorthWind * @Date: 2021-04-14 11:22:50 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 14:34:15 */
<template>
    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="sub_warranty_settlement"
        ></commonTable>
        <div class="page">
          <el-pagination
