/* * @Author: NorthWind * @Date: 2020-12-09 10:46:53 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 14:18:29 */
<template>
  <div id="subManagePay">
    <!-- 分包付款列表 -->
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :types="types"
          @getlist="getList"
          printTableName="sub_payment_application"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
          ...
          .then(() => {
            this.$axios
              .post('/newtao/payOperation', {
                ...
                id: val.id,
                pay_status: '1',
                biao_name: 'sub_payment_application',
              })
              .then(res => {
                if (res.data.code == 1) {
                  this.getList();
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/subPaymentApplication')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    getList(ntype) {
      this.$axios
        .post('/project/subPaymentApplicationList', {
          ...
          sub_unit: this.formInline.sub_unit,
    ...
    backList() {
      this.$axios
        .post('/project/subPaymentApplicationReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/subPaymentApplicationDownload', {
