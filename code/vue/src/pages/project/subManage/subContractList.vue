/* * @Author: NorthWind * @Date: 2020-12-09 10:24:43 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 11:43:22 */
<template>
...
export default {
  ...
  methods: {
    ...
    backList() {
      this.$axios
        .post('/project/subContractReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/subContractDownload', {
