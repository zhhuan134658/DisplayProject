/*
 * @Author: NorthWind 
 * @Date: 2021-01-20 09:46:00 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-08-16 15:41:35
 */
<template>
          ...
          <div slot="append">
            <div :class="tpList.length > 0 ? '' : 'newTableAppendBorder'">
              <div class="sum_footer xiaoji" ref="sum_xiaoji">
                ...
                <div class="sum_footer_unit over_sum_text" style="width: 121px">
                  <el-tooltip
                    class="item"
                    effect="dark"
                    :content="xxiaoji"
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.$axios
        .post('/projectone/materialRequirementPlanReport', {
        ...
        .then(res => {
          if (res.data.code == 1) {
            ...
            this.nxiaoji = res.data.need_quantity_subtotal;
            this.nheji = res.data.need_quantity_total;
            this.cxiaoji = res.data.refer_price_subtotal;
            this.cheji = res.data.refer_price_total;
            this.xxiaoji = res.data.subtotal;
            this.xheji = res.data.total;
            console.log(this.xxiaoji, 'xxiaojixxiaojixxiaoji');
            this.$nextTick(() => {
              setTimeout(() => {
                this.adjustWidth();
              }, 500);
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/projectone/materialRequirementPlanDownload', {
