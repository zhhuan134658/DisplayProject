/*
 * @Author: NorthWind 
 * @Date: 2021-01-20 08:45:18 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-08-16 15:43:04
 */
<template>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.$axios
        .post('/projectone/materialInventoryReport', {
        ...
        .then(res => {
          if (res.data.code == 1) {
            ...
            this.cxiaoji = res.data.zc_number_subtotal;
            this.cheji = res.data.zc_number_total;
            this.pxiaoji = res.data.pd_number_subtotal;
            this.pheji = res.data.pd_number_total;
            this.$nextTick(() => {
              setTimeout(() => {
                this.adjustWidth();
              }, 500);
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/projectone/materialInventoryDownload', {
