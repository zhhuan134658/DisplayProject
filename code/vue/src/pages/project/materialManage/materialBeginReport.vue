/*
 * @Author: NorthWind 
 * @Date: 2021-01-19 17:19:42 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-08-16 15:43:39
 */
<template>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.$axios
        .post('/projectone/inventoryBeginningReport', {
        ...
        .then(res => {
          if (res.data.code == 1) {
            ...
            this.dxiaoji = res.data.rk_number_subtotal;
            this.dheji = res.data.rk_number_total;
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/projectone/inventoryBeginningDownload', {
