/*
 * @Author: NorthWind 
 * @Date: 2020-12-08 13:58:22 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-01-21 17:04:53
 */
<template>
    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        >
          ...
          <el-table-column prop="material_contract" label="供应商" align="left">
          </el-table-column>
          <el-table-column prop="deliveryer" label="送货人" align="left">
          </el-table-column>
          <el-table-column prop="acceptor" label="验收人" align="left">
          </el-table-column>
          <el-table-column prop="check_dept" label="验收部门" align="left">
          </el-table-column>
          <el-table-column prop="riqi" label="进场时间" align="left">
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/materialAcceptanceRegister')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    getList() {
      this.$axios
        .post('/project/materialAcceptanceRegisterList', {
          ...
          acceptor: this.formInline.acceptor,
        })
        .then(res => {
          if (res.data.code == 1) {
    ...
    backList() {
      this.$axios
        .post('/project/materialAcceptanceRegisterReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/materialAcceptanceRegisterDownload', {
