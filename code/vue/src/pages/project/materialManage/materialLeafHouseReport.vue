/*
 * @Author: NorthWind 
 * @Date: 2021-01-20 08:58:23 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-08-16 15:42:25
 */
<template>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.$axios
        .post('/projectone/materialDeliveryReport', {
        ...
        .then(res => {
          if (res.data.code == 1) {
            ...
            this.cxiaoji = res.data.ck_number_subtotal;
            this.cheji = res.data.ck_number_total;
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/projectone/materialDeliveryDownload', {
