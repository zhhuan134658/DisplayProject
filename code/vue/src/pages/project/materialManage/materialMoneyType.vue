/*
 * @Author: NorthWind 
 * @Date: 2021-03-05 19:31:59 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-08-16 15:44:26
 */
<template>
      ...
      <div class="mainContent">
        ...
        >
          ...
          >
            <template slot="header" slot-scope="scope">
              <el-tooltip placement="top">
                <div slot="content">来源于：物资基础库的“物品类型”</div>
                <div>材料类型</div>
              </el-tooltip>
            </template>
          </el-table-column>
          ...
          >
            <template slot="header" slot-scope="scope">
              <el-tooltip placement="top">
                <div slot="content">来源于：材料入库明细的“含税金额”合计</div>
                <div>合计金额(元)</div>
              </el-tooltip>
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.$axios
        .post('/projectone/materialFeeReport', {
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/projectone/materialFeeDownload', {
