/*
 * @Author: NorthWind 
 * @Date: 2021-01-20 09:53:35 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-08-16 15:41:16
 */
<template>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.$axios
        .post('/projectone/materialAllPlanReport', {
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/projectone/materialAllPlanReportDownload', {
  ...
  mounted() {
    ...
    // });
    // this.allmaterial_name = this.$utils.getmaterialList();
    // console.log(this.$utils.getmaterialList());
