/* * @Author: NorthWind * @Date: 2020-12-08 09:54:24 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 09:31:29 */
<template>
    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="indirect_cost_budget"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/indirectCostBudget')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/indirectCostBudgetDownload', {
