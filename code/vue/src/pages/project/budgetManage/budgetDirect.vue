/*
 * @Author: NorthWind 
 * @Date: 2020-12-08 09:54:27 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-06-22 17:17:53
 */
<template>
  <div id="budgetDirect">
    <!-- 直接预算列表 -->
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="direct_cost_budget"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    backList() {
      this.$axios
        .post('/project/directCostBudgetReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/directCostBudgetDownload', {
