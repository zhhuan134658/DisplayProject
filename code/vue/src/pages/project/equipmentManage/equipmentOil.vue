/*
 * @Author: NorthWind 
 * @Date: 2020-12-10 14:44:53 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-08-16 16:00:26
 */
<template>
  <div id="equipmentOil">
    <!-- 设备油耗列表 -->
...
export default {
  ...
  methods: {
    ...
    backList() {
      this.$axios
        .post('/project/equipmentOilReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/equipmentOilDownload', {
