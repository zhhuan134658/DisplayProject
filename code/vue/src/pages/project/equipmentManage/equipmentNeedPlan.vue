/* * @Author: NorthWind * @Date: 2020-12-10 11:26:59 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 13:59:25 */
<template>
  <div id="equipmentNeedPlan">
    <!-- 设备需用列表 -->
    <div class="main">
      <commonSearch
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="equipment_demand_plan"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/equipmentDemandPlan')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    backList() {
      this.$axios
        .post('/project/equipmentDemandPlanReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/equipmentDemandPlanDownload', {
