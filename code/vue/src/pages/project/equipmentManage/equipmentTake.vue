/*
 * @Author: NorthWind 
 * @Date: 2020-12-10 14:14:25 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-01-21 17:02:42
 */
<template>
  <div id="equipmentTake">
    <!-- 设备领用列表 -->
    <div class="main">
      <!-- 搜索条件 -->
      <commonSearch
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="equipment_requisition"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/equipmentRequisition')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    getList(ntype) {
      this.$axios
        .post('/project/equipmentRequisitionList', {
          ...
          applicanter: this.formInline.applicanter,
    ...
    backList() {
      this.$axios
        .post('/project/equipmentRequisitionReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/equipmentRequisitionDownload', {
