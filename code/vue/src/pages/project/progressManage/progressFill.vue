/*
 * @Author: NorthWind 
 * @Date: 2020-12-12 11:09:41 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-01-21 17:07:49
 */
<template>
  <div id="progressFill">
    <!-- 填报填报列表 -->
...
export default {
  ...
  methods: {
    ...
    backList() {
      this.$axios
        .post('/project/progressReportReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/progressReportDownload', {
