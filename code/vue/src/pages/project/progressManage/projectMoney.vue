/*
 * @Author: NorthWind 
 * @Date: 2020-12-12 11:17:08 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-01-21 17:08:05
 */
<template>
  <div id="projectMoney">
    <!-- 项目产值列表 -->
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/outputValueRegister')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    backList() {
      this.$axios
        .post('/project/outputValueRegisterReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/outputValueRegisterDownload', {
