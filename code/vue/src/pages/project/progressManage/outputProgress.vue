/*
 * @Author: NorthWind 
 * @Date: 2020-12-12 10:39:51 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-01-21 17:07:38
 */
<template>
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/outputProgressPlan')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/outputProgressPlanDownload', {
