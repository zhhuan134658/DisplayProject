/* * @Author: NorthWind * @Date: 2021-04-26 14:42:20 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 14:42:42 */
<template>
  <div id="outputProgress">
    <!-- 复工报告 -->
    <div class="main">
      <!-- 搜索条件 -->
      <commonSearch
...
export default {
  ...
  methods: {
    ...
    getList(ntype) {
      this.$axios
        .post('/finance/returnto_worklist', {
          page: this.currentPage,
          number: this.pagesize,
          starttime: this.formInline.startTime,
          endtime: this.formInline.endTime,
          prepared: this.formInline.prepared,
    ...
    backList() {
      this.$axios
        .post('/project/outputProgressPlanReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
