/*
 * @Author: NorthWind 
 * @Date: 2020-12-10 09:59:17 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-01-21 17:01:18
 */
<template>
  <div id="buildDiaryList">
    <!-- 施工日志列表 -->
    <div class="main">
      <!-- 搜索条件 -->
      <commonSearch
...
export default {
  ...
  methods: {
    ...
    backList() {
      this.$axios
        .post('/project/constructionLogReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/constructionLogDownload', {
