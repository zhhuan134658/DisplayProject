/*
 * @Author: NorthWind 
 * @Date: 2020-12-10 10:46:23 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-01-20 16:40:08
 */
<template>
  <div id="buildSkill">
    <!-- 技术列表 -->
    <div class="main">
      ...
      <div class="mainContent">
        ...
        >
          ...
          <el-table-column prop="name" label="技术交底名称" align="left">
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/technicalDisclosure')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    backList() {
      this.$axios
        .post('/project/technicalDisclosureReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/technicalDisclosureDownload', {
