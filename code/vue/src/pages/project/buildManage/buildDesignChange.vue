/*
 * @Author: NorthWind 
 * @Date: 2020-12-10 10:38:38 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-01-21 17:00:25
 */
<template>
  <div id="buildDesignChange">
    <!-- 设计变更列表 -->
    <div class="main">
      <!-- 搜索条件 -->
      <commonSearch
      ...
      <div class="mainContent">
        ...
        >
          ...
          <el-table-column prop="name" label="设计变更名称" align="left">
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    backList() {
      this.$axios
        .post('/project/designChangeReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/designChangeDownload', {
