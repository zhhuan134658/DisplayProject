    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="tax_related_report"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/projecttwo/taxRelatedReportAdd')
        .then(res => {
    ...
    getList(ntype) {
      ...
      this.$axios   
        .post('/projecttwo/taxRelatedReportList', {
          page: this.currentPage,
          number: this.pagesize,
          shenpi: '',
          subject_unit:this.formInline.subject_unit,
    ...
    deleteList() {
      if (this.multSelectData.length > 0) {
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          .then(() => {
            this.$axios
              .post('/projecttwo/taxRelatedReportDel', {
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/projecttwo/taxRelatedReportload', {
