/* * @Author: NorthWind * @Date: 2020-12-08 10:45:23 * @Last Modified by:
mikey.zhaopeng * @Last Modified time: 2022-01-10 15:07:49 */
<template>
  <div id="progressPay">
    <!-- 进度款列表 -->
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="income_progresspay_declaration"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    getTitleList() {
      this.$axios
        .post('/spread/showFiledCurrencyList', {
          name: 'income_progresspay_declaration',
        })
        .then(res => {
          if (res.data.code == 1) {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/incomeProgresspayDeclaration')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    backList() {
      this.$axios
        .post('/project/incomeProgresspayDeclarationReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/incomeProgresspayDeclarationDownload', {
