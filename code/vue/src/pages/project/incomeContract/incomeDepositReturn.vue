    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          @getlist="getList"
            :isdele9="true"
            types='income_bond_return'
          printTableName="income_bond_return"
        ></commonTable>
        <div class="page">
          <el-pagination
  ...
  methods: {
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/finance/bondreturnapplydc', {
