/*
 * @Author: NorthWind 
 * @Date: 2021-04-14 10:47:57 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-06-22 17:21:04
 */
<template>
    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="income_warranty_settlement"
        ></commonTable>
        <div class="page">
          <el-pagination
    ...
    getTitleList() {
      this.$axios
        .post('/spread/showFiledCurrencyList', {
          name: 'income_warranty_settlement',
        })
        .then(res => {
          if (res.data.code == 1) {
