/* * @Author: NorthWind * @Date: 2020-12-08 10:52:29 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 14:19:31 */
<template>
    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          @getlist="getList"
          :codeShow="codeShow"
          printTableName="contract_collection"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/contractCollection')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    backList() {
      this.$axios
        .post('/project/contractCollectionReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/contractCollectionDownload', {
