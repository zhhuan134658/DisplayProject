        ...
        >
          ...
          >
            <template slot="header" slot-scope="scope">
              <el-tooltip placement="top">
                <div slot="content">
                  来源于财务-保证金付款登记中-付款类型中属于“履约保证金”付款登记金额
                  分批的话是多次的总和
                </div>
                <div>保证金支出(元)</div>
              </el-tooltip>
          ...
          >
            <template slot="header" slot-scope="scope">
              <el-tooltip placement="top">
                <div slot="content">
                  来源于财务-保证金收款款登记中-收款类型中属于“履约保证金”收款登记金额
                  分批退回的话是多次的总和
                </div>
                <div>保证金退回(元)</div>
              </el-tooltip>
  ...
  methods: {
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/finance/incomestatementdc', {
