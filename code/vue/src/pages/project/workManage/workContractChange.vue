/* * @Author: NorthWind * @Date: 2021-04-14 11:10:49 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 14:34:51 */
<template>
  <div id="workContractList">
    <!-- 劳务合同列表 -->
    <div class="main">
      <!-- 搜索条件 -->
      <commonSearch
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="service_visa_change"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    backList() {
      this.$axios
        .post('/project/serviceContractReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/finance/Laborchangevisadc', {
