      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :noClick='false'
           :isSet='false'
            :isdele9="true"
            types='services_bond_expenditure'
          printTableName="services_bond_expenditure"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    getTitleList() {
      this.$axios
        .post('/spread/showFiledCurrencyList', {
          name: 'services_bond_expenditure',
        })
        .then(res => {
          if (res.data.code == 1) {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/finance/services_bond_expenditure')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/finance/services_bond_expendituredc', {
