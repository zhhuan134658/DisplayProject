/*
 * @Author: NorthWind 
 * @Date: 2020-12-09 09:54:14 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-08-16 15:47:31
 */
<template>
  <div id="workSporadic">
    <!-- 零星劳务列表 -->
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="sporadic_service_list"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/sporadicServiceList')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    deleteList() {
      if (this.multSelectData.length > 0) {
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          .then(() => {
            this.$axios
              .post('/project/sporadicServiceListDel', {
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/sporadicServiceListDownload', {
