        ...
        <commonTable
          ...
          @getlist="getList"
            :noClick='false'
             :isSet='false'
            :isdele8="true"
            types='services_bond_return'
          printTableName="services_bond_return"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/finance/services_bond_return')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/finance/services_bond_returndc', {
