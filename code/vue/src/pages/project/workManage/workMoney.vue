/* * @Author: NorthWind * @Date: 2020-12-09 10:01:02 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 14:35:41 */
<template>
  <div id="workMoney">
    <!-- 项目工资列表 -->
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :codeShow="codeShow"
            ...
            :isdele1="true"
            @getlist='getList'
          printTableName="project_wage_register"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
          ...
          .then(() => {
            this.$axios
              .post('/newtao/payOperation', {
                ...
                id: val.id,
                pay_status:'1',
                biao_name:'project_wage_register'
              })
              .then(res => {
                if (res.data.code == 1) {
                  this.getList();
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/projectWageRegister')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    getList(ntype) {
      this.$axios
        .post('/project/projectWageRegisterList', {
          ...
          register: this.formInline.register,
    ...
    backList() {
      this.$axios
        .post('/project/projectWageRegisterReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/projectWageRegisterDownload', {
