/* * @Author: NorthWind * @Date: 2020-12-09 09:09:48 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 11:39:33 */
<template>
    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="service_contract"
        ></commonTable>
        <div class="page">
          <el-pagination
  ...
  methods: {
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/serviceContractDownload', {
