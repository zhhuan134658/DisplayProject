/*
 * @Author: NorthWind 
 * @Date: 2020-11-27 10:08:17 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-06-22 17:11:41
 */
<template>
  <div id="projectSurveyList">
    <!-- 项目勘察列表 -->
    <div class="main">
      <!-- 搜索条件 -->
      <commonSearch
...
export default {
  ...
  methods: {
    ...
    handleSelectionChange(val) {
      console.log(this.$utils.canDelete(val));
    ...
    backList() {
      this.$axios
        .post('/project/projectSurveyReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/projectSurveyDownload', {
