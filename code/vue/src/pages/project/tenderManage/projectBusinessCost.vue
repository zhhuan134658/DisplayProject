/*
 * @Author: NorthWind 
 * @Date: 2020-11-27 14:44:03 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-06-22 17:13:52
 */
<template>
  <div id="projectBusinessCost">
    <!-- 项目业务费申请列表 -->
    <div class="main">
      <!-- 搜索条件 -->
      <commonSearch
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/projectOperationCost')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    backList() {
      this.$axios
        .post('/project/projectOperationCostReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/projectOperationCostDownload', {
