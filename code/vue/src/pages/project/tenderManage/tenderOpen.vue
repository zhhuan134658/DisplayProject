/* * @Author: NorthWind * @Date: 2020-11-27 13:56:35 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 08:53:16 */
<template>
  <div id="tenderOpen">
    <!-- 开标登记列表 -->
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="bid_opening_register"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/bidOpeningRegister')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    backList() {
      this.$axios
        .post('/project/bidOpeningRegisterReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/bidOpeningRegisterDownload', {
