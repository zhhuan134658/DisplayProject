/* * @Author: NorthWind * @Date: 2020-11-27 09:58:29 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-12 16:15:06 */
<template>
  <div id="tenderFileCheck">
    <!-- 投标文件审查列表 -->
    <div class="main">
      <!-- 搜索条件 -->
      <commonSearch
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          :printTableName="'bid_file_examine'"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    backList() {
      this.$axios
        .post('/project/bidFileExamineReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/bidFileExamineDownload', {
