/* * @Author: NorthWind * @Date: 2020-11-26 14:12:40 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-12 16:12:44 */
<template>
  <div id="qualificationCheck">
    <!-- 资格自我审查列表 -->
    <div class="main">
      <!-- 搜索条件 -->
      <commonSearch
...
export default {
  ...
  methods: {
    ...
    backList() {
      this.$axios
        .post('/project/seniorityExamineReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/seniorityExamineDownload', {
