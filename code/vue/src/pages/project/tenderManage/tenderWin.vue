/* * @Author: NorthWind * @Date: 2020-11-27 13:59:37 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 09:14:21 */
<template>
  <div id="tenderWin">
    <!-- 中标登记列表 -->
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="bid_winning_register"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/bidWinningRegister')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    backList() {
      this.$axios
        .post('/project/bidWinningRegisterReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/bidWinningRegisterDownload', {
