      ...
      <div class="mainContent">
        ...
        >
          ...
          <!-- <el-table-column prop="project_name" label="项目名称" align="left">
                ...
                <el-table-column prop="party_a" label="单位" align="left">
          </el-table-column>

                    <el-table-column prop="my_account" label="账户信息" align="left">
          </el-table-column>
          ...
          >
              ...
              <el-table-column prop="payriqi" label="付款日期" align="left">
          </el-table-column>
        ...
        .then(res => {
          if (res.data.code == '1') {
            ...
            this.footerNumList = [
              ...
              { xj: res.data.xj_return_money, hj: res.data.zj_return_money },
              { xj: res.data.xj_not_money, hj: res.data.zj_not_money },
              { xj: '', hj: '' },
              { xj: '', hj: '' },
            ];
            this.$nextTick(() => {
