    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          :printTableName="'bidding_file_buy'"
        ></commonTable>
...
export default {
  ...
  methods: {
    ...
    backList() {
      this.$axios
        .post('/project/biddingFileBuyReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/biddingFileBuyDownload', {
