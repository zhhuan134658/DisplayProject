...
/*
 * @Author: NorthWind 
 * @Date: 2021-03-05 08:50:14 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-06-22 17:13:31
 */
<template>
  <div id="tenderBond">
    <!-- 投标保证金申请列表 -->
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          @getlist="getList"
          :isdele9="true"
          types="bid_bond_return"
          printTableName="bid_bond_return"
        ></commonTable>
        <div class="page">
          <el-pagination
  ...
  methods: {
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/projecttwo/bidBondReturnDownload', {
