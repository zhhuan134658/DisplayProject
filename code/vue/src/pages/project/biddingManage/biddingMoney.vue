/*
 * @Author: NorthWind 
 * @Date: 2020-12-08 09:54:55 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-06-22 17:16:45
 */
<template>
  <div id="biddingMoney">
    <!-- 招标报价对比列表 -->
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="bidding_offer_contrast"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/biddingOfferContrast')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    backList() {
      this.$axios
        .post('/project/biddingOfferContrastReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/biddingOfferContrastDownload', {
