/* * @Author: NorthWind * @Date: 2021-01-15 16:51:41 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 14:21:37 */
<template>
  <div id="biddingMoney">
    <!-- 招标中标 -->
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="zb_winning_register"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/zbWinningRegister')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    backList() {
      this.$axios
        .post('/project/zbWinningRegisterReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/zbWinningRegisterDownload', {
