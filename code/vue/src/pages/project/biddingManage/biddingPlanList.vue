/* * @Author: NorthWind * @Date: 2020-12-08 08:41:02 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 09:15:09 */
<template>
  <div id="biddingPlanList">
    <!-- 物资招标申请 -->
    <div class="main">
      <!-- 搜索条件 -->
      <commonSearch
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="large_material_bidding_plan"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    getTitleList() {
      this.$axios
        .post('/spread/showFiledCurrencyList', {
          name: 'large_material_bidding_plan',
        })
        .then(res => {
          if (res.data.code == 1) {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/largeMaterialBiddingPlan')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    getList(ntype) {
      this.$axios
        .post('/project/largeMaterialBiddingPlanList', {
          ...
          organer: this.formInline.organer,
    ...
    backList() {
      this.$axios
        .post('/project/largeMaterialBiddingPlanReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/largeMaterialBiddingPlanDownload', {
