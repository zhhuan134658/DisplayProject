...
export default {
  ...
  methods: {
    ...
    getList(ntype) {
      this.$axios
        .post('/affairs/directPackageList', {
          ...
          project_name_jing: this.formInline.name,
        })
        .then(res => {
          if (res.data.code == 1) {
            if (ntype == 1) {
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/affairs/directPackageDownload', {
