/* * @Author: NorthWind * @Date: 2020-12-09 16:50:24 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 13:53:51 */
<template>
    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="quality_inspection"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/qualityInspection')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    getList(ntype) {
      this.$axios
        .post('/project/qualityInspectionList', {
          ...
          quality_inspector: this.formInline.quality_inspector,
    ...
    backList() {
      this.$axios
        .post('/project/qualityInspectionReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/qualityInspectionDownload', {
