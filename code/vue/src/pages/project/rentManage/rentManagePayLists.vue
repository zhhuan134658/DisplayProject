/* * @Author: NorthWind * @Date: 2020-12-09 15:54:29 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 14:18:09 */
<template>
  <div id="rentManagePayList">
    <!-- 租赁付款列表 -->
    <div class="main">
      <!-- 搜索条件 -->
      <commonSearch
...
export default {
  ...
  methods: {
    ...
    backList() {
      this.$axios
        .post('/project/leasePaymentsReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/leasePaymentsDownload', {
