/* * @Author: NorthWind * @Date: 2020-12-09 13:36:43 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 13:48:54 */
<template>
  <div id="rentPlanList">
    <!-- 租赁计划列表 -->
    <div class="main">
...
export default {
  ...
  methods: {
    ...
    backList() {
      this.$axios
        .post('/project/leasingPlanReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/leasingPlanDownload', {
