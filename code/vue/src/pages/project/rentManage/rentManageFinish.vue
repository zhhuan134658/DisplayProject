/* * @Author: NorthWind * @Date: 2020-12-09 16:03:50 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 13:53:02 */
<template>
  <div id="rentManageFinish">
    <!-- 租赁结算列表 -->
    <div class="main">
      <!-- 搜索条件 -->
      <commonSearch
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="lease_settlement"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    backList() {
      this.$axios
        .post('/project/leaseSettlementReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/leaseSettlementDownload', {
