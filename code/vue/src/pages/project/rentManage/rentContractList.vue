/* * @Author: NorthWind * @Date: 2020-12-09 15:49:20 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 13:52:38 */
<template>
  <div id="rentContractList">
    <!-- 租赁合同列表 -->
    <div class="main">
      <!-- 搜索条件 -->
      <commonSearch
...
export default {
  ...
  methods: {
    ...
    backList() {
      this.$axios
        .post('/project/leaseContractReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/leaseContractDownload', {
