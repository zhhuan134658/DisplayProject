        ...
        if (result) {
            ...
            if (
                ...
                if (
                    ...
                    fromfar.x += this.fromSpot.equals(go.Spot.Left)
                        ? 99999
                        : -99999;
                    ...
                    p1.x += this.fromSpot.equals(go.Spot.Left)
                        ? endseg
                        : -endseg;
                    this.setPoint(1, p1);
                } else {
                ...
                if (tonode !== null && toport !== null) {
                    ...
                    far.x += this.fromSpot.equals(go.Spot.Left)
                        ? -99999 / 2
                        : 99999 / 2;
                ...
                if (fromnode !== null && fromport !== null) {
                    ...
                    far.x +=
                        parentlink !== null &&
                        parentlink.fromSpot.equals(go.Spot.Left)
                            ? -99999 / 2
                            : 99999 / 2;
