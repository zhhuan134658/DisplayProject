      ...
      this.$axios
        ...
        .then(res => {
          if (res.data.code == 1) {
            ...
            this.formInline.accountnumber = this.accountNumList[0].accountnumber;
          }
        })
    ...
    getList(ntype) {
      ...
      this.$axios
        .post('/finance/accountqclist', {
          ...
          addedby: this.formInline.addtouser,
          accountnumber: this.formInline.accountnumber,
          lctatus: this.formInline.status,
        })
        .then(res => {
          if (res.data.code == 1) {
            if (ntype == 1) {
