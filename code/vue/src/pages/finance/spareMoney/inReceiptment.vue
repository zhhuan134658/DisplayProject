    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <!-- 供应商收票付款汇总表 -->
          <el-tab-pane label="供应商收票付款汇总表" name="0">
            <el-table
              :border="true"
            ...
            >
              ...
              >
                <template slot="header" slot-scope="scope">
                  <el-tooltip placement="top">
                    <div slot="content">来源于：采购订单金额</div>
                    <div>订单金额(元)</div>
                  </el-tooltip>
                </template>
              </el-table-column>
              ...
              >
                <template slot="header" slot-scope="scope">
                  <el-tooltip placement="top">
                    <div slot="content">来源于：材料结算金额</div>
                    <div>结算金额(元)</div>
                  </el-tooltip>
                </template>
              </el-table-column>
        ...
        <!-- <el-tab-pane label="劳动合同收票付款汇总表" name="1">
            <el-table
              :border="true"
              class="moterialTotalClass"
              :max-height="650"
                  ...
                  <div class="sum_footer xiaoji" ref="sum_xiaojifb">
                    ...
                    <div class="sum_footer_unit center over_sum_text">
                      <el-tooltip
                        class="item"
                        effect="dark"
                        :content="xjsp_wf_money"
                        placement="t1op"
                      >
                        <div>{{ xjsp_wf_money }}</div>
                      </el-tooltip>
                    </div>
                  </div>
  ...
  methods: {
    ...
    //   console.log(row, column, cell, event);
      ...
      if (column.property == 'contract_money') {
        ...
        this.getpierceList('1', '/finance/cg_poolunit_pass', row, column);
        ...
        this.getpierceList('2', '/finance/cg_poolunit_pass', row, column);
        ...
        this.getpierceList('3', '/finance/cg_poolunit_pass', row, column);
        ...
        this.getpierceList('4', '/finance/cg_poolunit_pass', row, column);
        ...
        this.getpierceList('5', '/finance/cg_poolunit_pass', row, column);
      }
    },
    viewDia2(row, column, cell, event) {
      ...
      if (column.property == 'contract_money') {
        ...
        this.proName = `${'项目名称:' + row.project_name}`;
        this.totalMoney = `${'合同金额:' + event.target.innerText}`;
        this.getpierceList('1', '/finance/lw_poolunit_pass', row, column);
      } else if (column.property == 'sp_money') {
        //收票金额
        this.titleData = '数据来源';
        ...
        this.proName = `${'项目名称:' + row.project_name}`;
        this.totalMoney = `${'收票金额:' + event.target.innerText}`;
        this.getpierceList('2', '/finance/lw_poolunit_pass', row, column);
      } else if (column.property == 'js_money') {
        //结算金额
        this.titleData = '数据来源';
        ...
        this.proName = `${'项目名称:' + row.project_name}`;
        this.totalMoney = `${'结算金额:' + event.target.innerText}`;
        this.getpierceList('4', '/finance/lw_poolunit_pass', row, column);
      } else if (column.property == 'pay_money') {
        //付款金额
        this.titleData = '数据来源';
        ...
        this.proName = `${'项目名称:' + row.project_name}`;
        this.totalMoney = `${'付款金额:' + event.target.innerText}`;
        this.getpierceList('3', '/finance/lw_poolunit_pass', row, column);
      }
    },
    viewDia3(row, column, cell, event) {
      ...
      if (column.property == 'contract_money') {
        ...
        this.proName = `${'项目名称:' + row.project_name}`;
        this.totalMoney = `${'合同金额:' + event.target.innerText}`;
        this.getpierceList('1', '/finance/fb_poolunit_pass', row, column);
      } else if (column.property == 'sp_money') {
        //收票金额
        this.titleData = '数据来源';
        ...
        this.proName = `${'项目名称:' + row.project_name}`;
        this.totalMoney = `${'收票金额:' + event.target.innerText}`;
        this.getpierceList('2', '/finance/fb_poolunit_pass', row, column);
      } else if (column.property == 'js_money') {
        //结算金额
        this.titleData = '数据来源';
        ...
        this.proName = `${'项目名称:' + row.project_name}`;
        this.totalMoney = `${'结算金额:' + event.target.innerText}`;
        this.getpierceList('4', '/finance/fb_poolunit_pass', row, column);
      } else if (column.property == 'pay_money') {
        //付款金额
        this.titleData = '数据来源';
        ...
        this.proName = `${'项目名称:' + row.project_name}`;
        this.totalMoney = `${'付款金额:' + event.target.innerText}`;
        this.getpierceList('3', '/finance/fb_poolunit_pass', row, column);
      }
    },
    viewDia4(row, column, cell, event) {
      ...
      if (column.property == 'contract_money') {
        ...
        this.proName = `${'项目名称:' + row.project_name}`;
        this.totalMoney = `${'合同金额:' + event.target.innerText}`;
        this.getpierceList('1', '/finance/zl_poolunit_pass', row, column);
      } else if (column.property == 'sp_money') {
        //收票金额
        this.titleData = '数据来源';
        ...
        this.proName = `${'项目名称:' + row.project_name}`;
        this.totalMoney = `${'收票金额:' + event.target.innerText}`;
        this.getpierceList('2', '/finance/zl_poolunit_pass', row, column);
      } else if (column.property == 'js_money') {
        //结算金额
        this.titleData = '数据来源';
        ...
        this.proName = `${'项目名称:' + row.project_name}`;
        this.totalMoney = `${'结算金额:' + event.target.innerText}`;
        this.getpierceList('4', '/finance/zl_poolunit_pass', row, column);
      } else if (column.property == 'pay_money') {
        //付款金额
        this.titleData = '数据来源';
        ...
        this.proName = `${'项目名称:' + row.project_name}`;
        this.totalMoney = `${'付款金额:' + event.target.innerText}`;
        this.getpierceList('3', '/finance/zl_poolunit_pass', row, column);
      }
    },
    //获取穿透dialog里所有数据
    getpierceList(type, apiname, row, column) {
        console.log(column.property,'column.propertycolumn.property')
      this.$axios
        .post(apiname, {
          type,
        ...
        .then(res => {
          ...
          if (onenewArr.includes(column.property)) {
            ...
            }  else if (column.property == 'contract_money') {
              this.tableList = [
                res.data.data.issued_class_wages,
                res.data.data.material_contract,
                res.data.data.material_payment,
                res.data.data.sub_payment_application,
              ];
            }  else if (column.property == 'pay_money') {
              this.tableList = [
                res.data.data.lease_payments,
                res.data.data.material_payment,
                res.data.data.service_payment_alication,
     ...
     getpierceList1(type,apiname, row, column) {
      console.log(column.property,'rowrowrow');
     this.$axios
        .post(apiname, {
          type,
          project_name: row.project_name,
        ...
        .then(res => {
          let onenewArr = ['order_money','sp_money','shou_money','shui_money'];
        ...
        this.$axios
          ...
          .then(res => {
            if (res.data.code == 1) {
              ...
              this.xjwf_contract_money = res.data.xjwf_contract_money;
              this.zjwf_contract_money = res.data.zjwf_contract_money;
              this.xjsp_wf_money = res.data.xjsp_wf_money;
