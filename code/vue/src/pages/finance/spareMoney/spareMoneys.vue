    ...
    <div class="main">
        ...
        <div class="headerContent">
          ...
          >
            <div class="hlBottom">
              ...
              <el-form-item label="付款状态:" class="widths">
                <el-select
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isAdmin="isAdmin"
          @getlist='getList'
          types='zhukuai_reservefund'
          printTableName="zhukuai_reservefund"
        ></commonTable>
        <div class="page">
          <el-pagination
  ...
  methods: {
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/finance/byj_export', { id: _this.multSelectData })
          .then(res => {
            if (res.data.code == 1) {
