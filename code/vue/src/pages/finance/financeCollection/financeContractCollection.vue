/*
 * @Author: NorthWind 
 * @Date: 2020-12-17 11:30:22 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-01-20 15:56:22
 */
<template>
  <div id="financeContractCollection">
    <!-- 合同收款列表 -->
    <div class="main">
      <!-- 搜索条件 -->
      <commonSearch
...
export default {
  name: 'financeContractCollection',
  ...
  methods: {
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/finance/htsk_export', { id: _this.multSelectData })
          .then(res => {
            if (res.data.code == 1) {
