/* * @Author: NorthWind * @Date: 2020-12-15 17:16:57 * @Last Modified by:
mikey.zhaopeng * @Last Modified time: 2022-02-14 15:49:15 */
<template>
    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isBx="true"
          :isAdmin="isAdmin"
          types="zhukuai_costbx"
          printTableName="zhukuai_costbx"
        ></commonTable>
        <div class="page">
          <el-pagination
    ...
    getList(ntype) {
      ...
      this.$axios
        .post('/finance/overheadlist', {
          ...
          bxnumber: this.formInline.bxnumber,
          bxstatus: this.formInline.status,
          proname: this.formInline.proname,
          highmoney: this.formInline.highmoney,
          lowmoney: this.formInline.lowmoney,
