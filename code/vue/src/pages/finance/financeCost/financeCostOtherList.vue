/* * @Author: NorthWind * @Date: 2021-04-01 09:35:38 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 14:33:21 */
<template>
    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="zhukuai_costbx3"
        ></commonTable>
        <el-pagination
  ...
  methods: {
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/finance/otherexport', { id: _this.multSelectData })
          .then(res => {
            if (res.data.code == 1) {
