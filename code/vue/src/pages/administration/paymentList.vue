 ...
 * @Last Modified time: 2022-01-20 15:36:59
 */
<template>
  <div id="safeCheck">
    <!-- 付款登记 -->
  ...
  methods: {
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/affairs/fukuanDengjiDownload', {
