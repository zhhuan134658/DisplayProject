 ...
 * @Last Modified time: 2022-01-21 16:53:54
 */
<template>
  <div id="safeCheck">
    <!-- 工伤登记 -->
...
export default {
  ...
  methods: {
    ...
    getList(ntype) {
      ...
      this.$axios
        .post('/affairs/gongshangDengjiList', {
    ...
    deleteList() {
      if (this.multSelectData.length > 0) {
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          .then(() => {
            this.$axios
              .post('/affairs/gongshangDengjiDel', {
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/affairs/gongshangDengjiDownload', {
