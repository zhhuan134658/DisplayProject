 ...
 * @Last Modified time: 2022-01-21 16:54:05
 */
<template>
  <div id="safeCheck">
    <!-- 工资登记 -->
  ...
  methods: {
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/affairs/gongziDengjiDownload', {
