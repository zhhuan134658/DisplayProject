  ...
  <div id="materialBasic">
          ...
          <div class="waring_right">
            ...
            >
              ...
              <el-table-column prop="bi_li" label="预警比例(%)" align="left">
                  ...
                  <div>{{scope.row.bi_li=='0'?' ':scope.row.bi_li}}</div>
                </template>
              </el-table-column>
    ...
    >
      ...
      >
        ...
        <el-form-item label="预警接收人" prop="yj_person" v-if="types == '1' && waringForm.status_s">
...
export default {
  ...
  methods: {
    ...
    rightClick(item, index) {
      ...
      this.typesd = item.type;
    },
    editCancel() {
      this.dialogFormVisible = false;
      this.getList(this.typesd);
    },
    editRow(data) {
    ...
    editInfo(formName) {
      ...
      console.log(
        ...
        '_this.waringForm.symbol_this.waringForm.symbol',
         ...
         console.log(_this.waringForm.status_s,'///',_this.waringForm.qyj_status_s, '----');
      if(_this.waringForm.status_s == false && _this.waringForm.qyj_status_s == false){
    ...
    //   console.log(_this.waringForm,'_this_this')
      ...
      if (_this.cctagsData.length == 0 && _this.types == '1' && _this.waringForm.status_s) {
        _this.$message({
          message: '请添加接收预警人',
          type: 'warning',
          duration: 1500,
