    ...
    <div class="imgUpload" id="mpupload">
      <div id="excelcontainer" style="margin-bottom: 20px">
        <a id="excelselectfiles" href="javascript:void(0);" class="btn">
          <el-button type="primary" size="medium" plain>选择文件</el-button>
        </a>
      </div>
  ...
  methods: {
    ...
    initPlUploader() {
      ...
      _this.uploader2 = new plupload.Uploader({
        ...
        flash_swf_url: '<%= BASE_URL %>static/js/plupload-2.1.2/js/Moxie.swf',
        silverlight_xap_url:
        ...
        init: {
          ...
          FileUploaded: function (up, file, info) {
            ...
            if (info.status == 200) {
              ...
              _this.upImgList2 = _this.get_uploaded_object_name(file.name);

              // let len = _this.upImgList2.length;

              // for (var b = 0; b < len; b++) {
              _this.licenceImg2 = _this.hostUp + '/' + _this.upImgList2;
              // }
